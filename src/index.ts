...
const generateMockTransactions = (): Transaction[] => [
  ...
  },
  {
    id: '3',
    date: '2025-12-04',
    description: 'Freelancer Payment - Design',
    amount: -3500,
    currency: 'USD',
    type: 'expense',
  ...
  },
  {
    id: '4',
    date: '2025-12-03',
    description: 'Subscription Revenue - December',
    amount: 8750,
    currency: 'USD',
    type: 'income',
  ...
  },
  {
    id: '6',
    date: '2025-12-01',
    description: 'ETH to USDC Conversion',
    amount: 5000,
    currency: 'USDC',
    type: 'transfer',
...
export const useStore = create<AppState>()(
  persist(
    (set) => ({
      ...
      cryptoTokens: generateMockCryptoTokens(),
      ...
      aiSuggestions: [
        {
          ...
          description: 'Your home office expenses may qualify for additional deductions. Consider tracking utility costs.',
          impact: 'Potential savings: $2,400/year',
          priority: 'high',
          actions: [
            { type: 'suggestion', label: 'Set up tracking', payload: { category: 'home_office' } },
          ],
        },
        {
          id: '2',
          ...
          description: '5 transactions from the last week need categorization for accurate reporting.',
          priority: 'medium',
          actions: [
            { type: 'categorize', label: 'Review now', payload: { count: 5 } },
          ],
        },
      ],
