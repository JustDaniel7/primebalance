...
export function TransactionsIcon({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      <path d="M17 3v18" />
      <path d="M10 18l7-3-7-3" />
      <path d="M7 21V3" />
      <path d="M14 6l-7 3 7 3" />
    </svg>
  )
}

export function AccountsIcon({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function EthereumIcon({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M12 1.5l-6.5 11L12 16l6.5-3.5L12 1.5zm-6.5 12L12 22.5l6.5-9L12 17l-6.5-3.5z" />
    </svg>
  )
}
...
export function BitcoinIcon({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M11.5 11.5v-3h1a1.5 1.5 0 1 1 0 3h-1zm0 5v-3h1.5a1.5 1.5 0 0 1 0 3H11.5z" />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M10 4V2h2v2h2V2h2v2.26A6 6 0 0 1 15.5 16.2 6 6 0 0 1 14 22h-2v-2H8v2H6v-2.26A6 6 0 0 1 6.5 7.8 6 6 0 0 1 10 4zm1.5 2h-1A4 4 0 0 0 8 13.65V14h3.5V6zm0 10H8v.35A4 4 0 0 0 10.5 20h1v-4zm2 4h1a4 4 0 0 0 0-8h-1v8zm0-10V6h1a4 4 0 0 1 0 8h-1v-4z"
      />
    </svg>
  )
}
