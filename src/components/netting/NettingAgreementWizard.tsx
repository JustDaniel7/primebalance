...
export default function NettingPage() {
    const { t } = useThemeStore();
    const { sessions, agreements, createAgreement, selectSession, selectedSessionId } = useNettingStore();
    ...
    const handleCreateAgreement = (agreementData: any) => {
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <div className="flex gap-2">
                    ...
                    <Button variant="primary" leftIcon={<Plus size={18} />}>
                        {t('netting.newSession') || 'New Session'}
                    </Button>
                </div>
            </div>
            ...
            <AnimatePresence>
                {showWizard && <NettingAgreementWizard onCloseAction={() => setShowWizard(false)} onCompleteAction={handleCreateAgreement} />}
            </AnimatePresence>
        </div>
    );
}