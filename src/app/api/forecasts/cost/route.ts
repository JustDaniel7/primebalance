// src/app/api/forecasts/cost/route.ts
...
export async function POST(req: NextRequest) {
  ...
  const forecast = await prisma.costForecast.create({
    data: {
      ...
      committedCosts: body.committedCosts || 0,
      estimatedCosts: body.estimatedCosts || 0,
      byCategory: body.byCategory || {},
      byDepartment: body.byDepartment || {},
