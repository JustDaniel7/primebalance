        ...
        <Card variant="elevated" padding="lg">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-gray-100 dark:bg-surface-800/50 border border-gray-200 dark:border-surface-700/50 text-gray-700 dark:text-surface-300 hover:bg-gray-200 dark:hover:bg-surface-700/50 transition-colors"
            >
