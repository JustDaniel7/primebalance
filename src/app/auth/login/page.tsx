        ...
        <Card variant="elevated" padding="lg">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 rounded border-gray-300 dark:border-surface-600 text-[var(--accent-primary)] focus:ring-[var(--accent-primary)]"
                />
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-white dark:bg-surface-900 text-gray-500 dark:text-surface-400">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-gray-100 dark:bg-surface-800/50 border border-gray-200 dark:border-surface-700/50 text-gray-700 dark:text-surface-300 hover:bg-gray-200 dark:hover:bg-surface-700/50 transition-colors">
          ...
          <p className="text-center text-sm text-gray-500 dark:text-surface-400 mt-6">
            {t('auth.noAccount')}{' '}
